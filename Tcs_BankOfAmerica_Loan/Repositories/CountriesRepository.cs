...
namespace Tcs_BankOfAmerica_Loan.Repositories
{
    ...
    public class CountriesRepository : ICountriesRepository
    {
        ...
        string connectionString = "data source=DESKTOP-AM7K2K6; integrated security=yes; initial catalog=hotelmanagement";
        //sqlserver authentication connectionstring
        // string connectionString = "data source=DESKTOP-AM7K2K6; user id=sa; password=S@12345; initial catalog=hotelmanagement";
